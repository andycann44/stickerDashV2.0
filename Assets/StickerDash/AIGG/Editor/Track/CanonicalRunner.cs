  ...
  public static class CanonicalRunner {
    ...
    public static void RunLast(){
      ...
      foreach(var line in lines){
        ...
        if((m=rxHoles.Match(line)).Success){ float pct=float.Parse(m.Groups[1].Value,System.Globalization.CultureInfo.InvariantCulture); TrackSceneBuilder.RandomHoles(pct); continue; }
